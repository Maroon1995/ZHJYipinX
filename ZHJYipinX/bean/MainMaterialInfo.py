...
class MainMaterial(Base):
    '''
    继承基类
    '''
    __tablename__ = readConfig()["tablename"]["MainMaterial"]  # 主数据表的名字
    ...
    def keys(self):
        return ["PDM_ID", "ITEM_ID", "ITEM_NAME_CH", "ITEM_NAME_EN", "ITEM_UNIT", "ONE_TYPE", "ITEM_ID_ORIGINAL",
                "PEOPLE_ONLYITEM", "PEOPLE_NAME_CH", "PEOPLE_NAME_EN", "PEOPLE_UNIT"]

    def __getitem__(self, item):
        return self.__getattribute__(item)

    def __init__(self, PDM_ID, ITEM_ID, ITEM_NAME_EN, ITEM_NAME_CH, ITEM_UNIT, ONE_TYPE, ITEM_ID_ORIGINAL,
                 PEOPLE_ONLYITEM, PEOPLE_NAME_CH, PEOPLE_NAME_EN, PEOPLE_UNIT):
        self.PDM_ID = PDM_ID
